module github.com/tom-elvidge/flowmetricsconnector/test

go 1.25.0

require (
	github.com/stretchr/testify v1.10.0
	github.com/tom-elvidge/flowmetricsconnector v0.0.0
...
replace github.com/tom-elvidge/flowmetricsconnector => ../
